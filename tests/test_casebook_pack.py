"""Regression checks for the copper-parse-regex-stack casebook."""
...
from casebook.harness import assert_expected, copper_parse_regex_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_parse_regex_stack_summary(), assert_expected())
